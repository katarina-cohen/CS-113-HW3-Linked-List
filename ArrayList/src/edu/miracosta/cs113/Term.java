...
public class Term implements Comparable<Term>, Cloneable {
    ...
    */
    ...
    /**
    *Default constructor, initializes Term to coefficient and exponent constants if nothing 
    *provided.
    */
    public Term() {
    ...
    /**
    *Copy constructor creates an object of type Term by initializing it with a Term object that 
    *has been created previously, if this Term is not null.
    *
    ...
    */
    ...
    /**
    *equals() method that compares one term's coefficient and exponent to another's to 
    *assess equality.
    *
