...
public class Polynomial extends Term {
  ...
  */
  ...
  /**
  *Adds the entered term to a given polynomial. A new coefficient is calculated if the exponent matches that of a preexisting term. Method also makes sure terms are added in the correct order with highest exponents first.
  *
